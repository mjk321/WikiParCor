...
DIR = os.path.join(os.getcwd(), LANG_PAIR+"\\data\\cleaning station\\")
#os.makedirs(DIR)

with open(os.path.join(DIR,LANG_PAIR+'_2_'+TGT_LANG+'-'+DES_LANG+'_'+DES_LANG+'Wikiarticles-cleaned.txt'), "r", encoding = 'utf-8') as f, \
open(os.path.join(DIR,LANG_PAIR+'_2_'+TGT_LANG+'-'+DES_LANG+'_'+DES_LANG+'Wikiarticles-cleaned_new lines_cleaned.txt'), "w", encoding = 'utf-8') as f1:
